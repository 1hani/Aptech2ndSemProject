                  ...
                  <div class="container-fluid">
                     <div class="carousel-caption relative">
                        <div class="row d_flex">
                           ...
                           <div class="col-md-6">
                              <span>01/03</span>
                              <h1>H&S Elegance Salon Creating Beauty</h1>
                  ...
                  <div class="container-fluid">
                     <div class="carousel-caption relative">
                        <div class="row d_flex">
                           ...
                           <div class="col-md-6">
                              <span>02/03</span>
                              <h1>H&S Elegance Salon, nail Salon Creating Beauty</h1>
                              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempo</p>
                              <a class="get_btn" href="Javascript:void(0)" role="button">Get Appoinment</a>
                           </div>
                        </div>
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="pricing_box h-100 w-100">
                     ...
                     <div class="our_pricing">
                        <span>Standard</span>
                        <p>Enhanced services with more detail and relaxation.</p>
                     </div>
                  </div>
                  <a class="read_more mar_top" href="Javascript:void(0)">Book Now</a>
               </div>
               <div class="col-md-4">
                  <div class="pricing_box h-100 w-100">
                     ...
                     <div class="our_pricing">
                        <span>Premium</span>
                        <p>Luxurious treatments with top-tier care and designs.</p>
                     </div>
                  </div>
                  <a class="read_more mar_top" href="Javascript:void(0)"> Book Now</a>
               </div>
            ...
            <div class="row">
               <div class="col-md-6 offset-md-3">
                  <form id="request" class="main_form">
                     <div class="row">
                        <div class="col-md-12 ">
                           <input class="contactus" placeholder="Full Name" type="type" name="Full Name" id="animation"> 
                        </div>
                        <div class="col-md-12">
                           <input class="contactus" placeholder="Email " type="type" name="Email " id="animation"> 
                        </div>
                        <div class="col-md-12">
                           <input class="contactus" placeholder="Phone Number" type="type" name="Phone Number" id="animation">                          
                        </div>
                        <div class="col-md-12">
